...
urlpatterns = [
    ...
    path('organizer/createEvent', views.CreateEventView.as_view(), name='create_event'),
    ...
    path('organizer/event/about/<int:pk>/createAttraction/', views.CreateAttractionView.as_view(), name = 'create_attraction'),
    path('organizer/event/about/tickets/<int:pk>/', views.OrgTicketsView.as_view(), name='event_tickets'),
    path('organizer/event/about/<int:pk>/createTicket/', views.CreateTicketsView.as_view(), name = 'create_ticket'),
